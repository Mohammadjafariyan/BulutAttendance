...
@org.springframework.data.elasticsearch.annotations.Document(indexName = "orgposition")
...
public class OrgPosition implements Serializable {
    ...
    public OrgPosition title(String title) {
        this.setTitle(title);
        return this;
    }
    ...
    public OrgPosition status(RecordStatus recordStatus) {
    ...
    public OrgPosition internalUser(ApplicationUser applicationUser) {
    ...
    public OrgPosition company(Company company) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OrgPosition)) {
            return false;
        }
        return getId() != null && getId().equals(((OrgPosition) o).getId());
    }
