...
/**
 * REST controller for managing {@link com.bulut.attendance.domain.Company}.
 */
@RestController
...
public class CompanyResource {
    ...
    private static final String ENTITY_NAME = "bulutAttendanceCompany";
     ...
     */
    @GetMapping("/_search")
    public List<Company> searchCompanies(@RequestParam("query") String query) {
