...
type CompanyFormGroupContent = {
  ...
  title: FormControl<ICompany['title']>;
  logo: FormControl<ICompany['logo']>;
  status: FormControl<ICompany['status']>;
  internalUser: FormControl<ICompany['internalUser']>;
};
...
export class CompanyFormService {
  createCompanyFormGroup(company: CompanyFormGroupInput = { id: null }): CompanyFormGroup {
    ...
    return new FormGroup<CompanyFormGroupContent>({
      ...
      title: new FormControl(companyRawValue.title),
      logo: new FormControl(companyRawValue.logo),
      status: new FormControl(companyRawValue.status),
      internalUser: new FormControl(companyRawValue.internalUser),
    });
  }
