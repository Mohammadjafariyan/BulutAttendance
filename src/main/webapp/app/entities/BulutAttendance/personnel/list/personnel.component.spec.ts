...
import { sampleWithRequiredData } from '../personnel.test-samples';
...
describe('Personnel Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, PersonnelComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.personnel?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });
