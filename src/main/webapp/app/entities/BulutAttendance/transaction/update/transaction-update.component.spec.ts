...
describe('Transaction Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call ApplicationUser query and add missing value', () => {
      ...
      const internalUser: IApplicationUser = { id: 32107 };
      transaction.internalUser = internalUser;

      const applicationUserCollection: IApplicationUser[] = [{ id: 3104 }];
    ...
    it('Should call Company query and add missing value', () => {
      const transaction: ITransaction = { id: 456 };
      const company: ICompany = { id: 32758 };
      transaction.company = company;

      const companyCollection: ICompany[] = [{ id: 28220 }];
    ...
    it('Should update editForm', () => {
      const transaction: ITransaction = { id: 456 };
      const internalUser: IApplicationUser = { id: 5144 };
      transaction.internalUser = internalUser;
      const company: ICompany = { id: 29888 };
      transaction.company = company;
