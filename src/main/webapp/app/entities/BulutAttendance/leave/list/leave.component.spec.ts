...
import { sampleWithRequiredData } from '../leave.test-samples';
...
describe('Leave Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, LeaveComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.leaves?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });
